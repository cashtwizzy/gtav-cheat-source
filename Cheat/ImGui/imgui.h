...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          UniversalStyle(ImGuiStyle* dst = NULL);    // new, recommended style (default)
...
// During the frame, use ImGui::PushStyleVar(ImGuiStyleVar_XXXX)/PopStyleVar() to alter the main style values, https://github.com/cashtwizzy
