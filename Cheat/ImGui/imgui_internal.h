...
namespace ImGui
{
    ...
    // Shade functions (write over already created vertices) https://github.com/cashtwizzy
...
} // namespace ImGui https://github.com/cashtwizzy

// ImFontAtlas internals https://github.com/cashtwizzy
